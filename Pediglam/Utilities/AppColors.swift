...
extension Color {
    ...
    static let cardBackground = Color(UIColor { traitCollection in
        traitCollection.userInterfaceStyle == .dark ? UIColor(red: 28/255, green: 28/255, blue: 30/255, alpha: 1.0) : UIColor(red: 245/255, green: 245/255, blue: 247/255, alpha: 1.0)
    })
